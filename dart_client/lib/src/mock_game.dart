...
class MockGameGenerator {
  ...
  static final List<MockCommander> _commanders = [
    ...
    MockCommander(
      ...
      crop:
          'https://cards.scryfall.io/art_crop/front/1/7/175ad810-3cdd-43c7-99a9-8a2e8ad6dbae.jpg?1743206587',
      image:
          'https://cards.scryfall.io/normal/front/1/7/175ad810-3cdd-43c7-99a9-8a2e8ad6dbae.jpg?1743206587',
    ),
    MockCommander(
      name: 'Borborygmos Enraged',
      crop:
          'https://cards.scryfall.io/art_crop/front/0/2/02df18c5-07b9-4e85-9c4b-58b63fa59437.jpg?1702429604',
      image:
          'https://cards.scryfall.io/normal/front/0/2/02df18c5-07b9-4e85-9c4b-58b63fa59437.jpg?1702429604',
    ),
    MockCommander(
      name: 'Anzrag, the Quake-Mole',
      crop:
          'https://cards.scryfall.io/art_crop/front/7/0/70e9d8b8-4b32-4414-b32f-1f47523239c5.jpg?1706242114',
      image:
    ...
    MockCommander(
      name: 'The Mimeoplasm',
      crop:
          'https://cards.scryfall.io/art_crop/front/9/9/998b86f3-e53f-4ebb-b111-6f14577fded1.jpg?1712354748',
      image:
          'https://cards.scryfall.io/normal/front/9/9/998b86f3-e53f-4ebb-b111-6f14577fded1.jpg?1712354748',
    ),
  ];
  ...
  static List<CreateRankingRequest> generateMockRankings(
      List<String> playerIds) {
    if (playerIds.length < 2 || playerIds.length > 4) {
      throw ArgumentError(
          'Player IDs list must contain between 2 and 4 players');
    }

    // Shuffle commanders and take the required number
    final shuffledCommanders = List<MockCommander>.from(_commanders)
      ..shuffle(_random);
    final selectedCommanders =
        shuffledCommanders.take(playerIds.length).toList();

    final rankings = <CreateRankingRequest>[];
    for (int i = 0; i < playerIds.length; i++) {
      final commander = selectedCommanders[i];
      final playerId = playerIds[i];

      rankings.add(CreateRankingRequest(
