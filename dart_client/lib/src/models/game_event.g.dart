...
GameEvent _$GameEventFromJson(Map<String, dynamic> json) => GameEvent(
      ...
      sourceRanking: json['source_ranking'] == null
          ? null
          : Ranking.fromJson(json['source_ranking'] as Map<String, dynamic>),
      targetRanking: json['target_ranking'] == null
          ? null
...
Map<String, dynamic> _$GameEventToJson(GameEvent instance) => <String, dynamic>{
      ...
      'source_ranking': instance.sourceRanking,
