...
func (r *Repository) AddDeckToPlayer(playerID uint, moxfieldURL, commander, image string) (*Deck, error) {
	deck := Deck{MoxfieldURL: moxfieldURL, Commander: commander, Image: image, PlayerID: playerID}
