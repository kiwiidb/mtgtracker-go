...
import (
	...
	"mtgtracker/internal/statistics"
...
func main() {
	...
	statsHandlers := statistics.NewEventHandlers(statsRepo, coreService)
	statsHandlers.RegisterHandlers(eventBus)
	...
	statsService.RegisterRoutes(mux)
